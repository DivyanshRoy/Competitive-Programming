// Problem Link: https://www.codechef.com/COOK82/problems/COOK82B
...
int main()
{
    long long int n,v,ans=1,i,p,t,need,cmp=1,sum=0;
    cin>>n;
    for(i=0;i<n;i++)
    {
        cin>>v;
    ...
    map<llui,long int>::iterator iter;
